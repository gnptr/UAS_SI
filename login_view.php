...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url('<?php echo base_url('assets_style/image/backgroundlogin.png');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <img src="assets_style/image/logouin.png">
    <a href="index.php" style="color:cornsilk" ><h2>INTEGRATED LIBRARY INFORMATION SYSTEM</h2></a>
  </div>
